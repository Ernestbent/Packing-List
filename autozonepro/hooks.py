...
doctype_js = {
    "Sales Order": [
        ...
        "public/js/main_location_stock_transfer.js",
...
doc_events = {
    ...
    "Payment Entry": {
        ...
        "before_save": "autozonepro.autozonepro.custom_scripts.payment_entry_hooks.validate",
        "before_submit": "autozonepro.autozonepro.custom_scripts.payment_entry_hooks.validate",
    },
    "Sales Order": {
...
scheduler_events = {
    "cron": {
        "0 7 * * *": [
            "autozonepro.autozonepro.custom_scripts.price_change_mail.send_price_changes",
        ],
    }
}
